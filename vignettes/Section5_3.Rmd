...
Section 5.3 of the paper studies the case with more than one endogenous
treatment. Several treatments can be affected by the same unobserved
confounder, so the joint distribution of the treatments matters.
...
In this setting the target is a partial interventional mean function with more
than one endogenous variable. The point of the example is to check whether the
method can still recover that function when the joint distribution of the
treatments matters.
